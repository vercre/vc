...
mod tests {
    ...
    use super::super::state::{Authorized, Deferrance, Expire, Token};
    use super::*;
    use crate::openid::issuer::{CredentialRequest, CredentialResponseType, ProofClaims};
    use crate::snapshot;
    use crate::test_utils::issuer::{Provider, CLIENT_ID, CREDENTIAL_ISSUER, NORMAL_USER};
    use crate::test_utils::{self};
    use crate::w3c_vc::proof::{self, Payload, Type, Verify};
    ...
    async fn deferred_ok() {
        ...
        let jws = JwsBuilder::new()
            ...
            .payload(claims)
            .add_signer(&test_utils::holder::Provider)
            .build()
            .await
